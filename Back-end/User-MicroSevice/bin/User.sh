...
JAR_NAME="User-Service-REL1.0.jar"
...
JAR_DIR="/C/GitHub-Projects/Home-Food/Home-food-Portal/Back-end/User-MicroSevice/target/" #Change this Path according to your local setup
...
PID_FILE="${LOG_PATH}/user.pid"

# Log file for the application's standard output and error.
LOG_FILE="${LOG_PATH}/user_logs.log"
